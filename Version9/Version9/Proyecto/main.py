...
pg.display.set_caption("Proyecto")
...
class Intro():
    def __init__(self):
        ...
        self.alpha = -5
        self.imgLogo = pg.image.load("Proyecto/images/logo.png")
...
class Start():
    def __init__(self):
        ...
        self.imgWin = pg.image.load("Proyecto/images/win.png")
...
if pg.mixer.get_init() is None:
    ...
    soundMultiSnake = pg.mixer.Sound('Proyecto/sounds/snakeMulti.mp3')
    soundRecord = pg.mixer.Sound('Proyecto/sounds/record.mp3')
    soundPoint = pg.mixer.Sound('Proyecto/sounds/point.mp3')
    soundGameOver = pg.mixer.Sound('Proyecto/sounds/gameOver.mp3')
